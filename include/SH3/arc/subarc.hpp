...
namespace sh3 { namespace arc {
    ...
    public:
        ...
        public:
             ...
             *  
             *  @param searchedFilename The name of the file that was attempted to be loaded.
             *  @param searchedSubarc   The name of the @ref subarc it was attempted to be loaded from.
             */
             ...
             *  
             *  @param read_magic The magic value read from the header.
             */
             ...
             *  
             *  @param headerTyoe The type of the header.
             *  @param numRead    The number of bytes that could be retrieved.
             */
